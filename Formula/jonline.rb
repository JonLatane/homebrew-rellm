...
class Jonline < Formula
  ...
  url "https://github.com/jonlatane/jonline/releases/download/v0.5.553-db9997f/jonline-0.5.553-db9997f-macos-arm64.tar.gz"
  sha256 "8dd03276a3174914ce6e77d51a443f982d6b9d478341cac33cda0427e6d30b65"
  version "0.5.553-db9997f"
  ...
  def install
    ...
    (bin/"jonline").write <<~SCRIPT
                ...
                Commands:
                  ...
                  Deployment (requires `make` -- manage your own Kubernetes cluster):
                    ...
                    deploy <targets...>      Run `make` targets from the bundled deploys/Makefile, e.g.:
                                             ...
                                             default. See #{etc}/jonline/opt/deploys/README.md (bundled
                ...
                _jonline_deploys_dir="#{etc}/jonline/opt/deploys"
